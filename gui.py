from tkinter import Button, Entry, Frame, Label, Menu, Tk
...
btn_novo_pdf = Button(frm_botoes, text='Carregar', command=cria_frame, font=fonte)
btn_novo_pdf.pack(side=LEFT)
btn_remove_pdf = Button(frm_botoes, text='Remover', command=apaga_frame, font=fonte)
btn_remove_pdf.pack(side=LEFT)
btn_limpar = Button(frm_botoes, text='Limpar', command=limpar_pdfs, font=fonte)
btn_limpar.pack(side=LEFT)
frm_botoes.pack()

btn_juntar = Button(janela, text='Juntar', font=fonte, state='disable')
